...
func (t *BondChaincode) getContracts(stub *shim.ChaincodeStub, issuerID string) ([]bond, error) {
...
func (t *BondChaincode) createContracts(stub *shim.ChaincodeStub, bond_ bond) ([]byte, error) {
